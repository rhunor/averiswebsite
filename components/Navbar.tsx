    ...
    <>
      ...
      >
        <div className="max-w-[1240px] mx-auto px-8 flex items-center justify-between">
          ...
          >
            <span className={`block w-[22px] h-[1.5px] bg-white rounded-sm transition-transform duration-300 ${menuOpen ? 'translate-y-[6.5px] rotate-45' : ''}`} />
            <span className={`block w-[22px] h-[1.5px] bg-white rounded-sm transition-opacity duration-300 ${menuOpen ? 'opacity-0' : ''}`} />
            <span className={`block w-[22px] h-[1.5px] bg-white rounded-sm transition-transform duration-300 ${menuOpen ? '-translate-y-[6.5px] -rotate-45' : ''}`} />
          </button>
        </div>
      </header>
