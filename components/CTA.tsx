...
export default function CTA() {
  return (
    <section id="contact" className="py-[70px] md:py-[100px] bg-[#f5f8fa]">
      <div className="max-w-[1240px] mx-auto px-5 sm:px-8">
        <motion.div
          ...
          className="relative overflow-hidden rounded-[24px] sm:rounded-[32px] px-6 sm:px-16 py-[60px] sm:py-[90px] text-center"
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <motion.p
              ...
              viewport={{ once: true, margin: '-60px' }}
              className="text-[16px] sm:text-[18px] text-white/75 max-w-[470px] mx-auto leading-[1.72] mb-8 sm:mb-11"
            >
            ...
            >
              <a
                ...
                className="inline-flex items-center justify-center gap-[10px] w-full sm:w-auto px-8 sm:px-9 py-[16px] sm:py-[18px] bg-white text-navy-dark text-[15px] font-black rounded-lg hover:-translate-y-[2px] hover:shadow-[0_18px_44px_rgba(0,0,0,0.22)] transition-all duration-300 relative overflow-hidden group"
              >
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-[10px] w-full sm:w-auto px-8 sm:px-9 py-[16px] sm:py-[18px] bg-transparent text-white text-[15px] font-black rounded-lg border border-white/28 hover:border-white/65 hover:bg-white/8 hover:-translate-y-[2px] transition-all duration-300"
              >
                ✉️ Send an Email
              </a>
            </motion.div>
